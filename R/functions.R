  ...
  function(number_mc_samples,
    ...
    for(i in 1:length(fitting_data$FITTING_TIME)){
      ...
      tmp_time_varying_temps_dt <- 
        subset(all_data, 
               DATE <= fitting_data$DATE[i])
      if(transm_cycle == TRUE){
        tmp_results <- 
          time_varying_monte_carlo_generator_function_temps(number_time_varying_mc_samples,
                                                          tmp_fixed_t,
                                                          tmp_time_varying_temps_dt,
                                                          siraj_2017_params)
      }
        ...
        tmp_results <- 
          time_varying_monte_carlo_generator_function_ignoring_transm_cycle_temps(number_time_varying_mc_samples,
                                                            tmp_fixed_t,
                                                            tmp_time_varying_temps_dt,
                                                            siraj_2017_params)
      }
